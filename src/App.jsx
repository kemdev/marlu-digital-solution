...
function App() {
  ...
  return (
    ...
    >
      ...
      <ContactForm basicModal={basicModal} setBasicModal={setBasicModal} toggleShow={toggleShow} sent={sent} setSent={setSent}/>
      <GeneralForm  toggleGeneralFormShow={toggleGeneralFormShow} centredModal={centredModal} setCentredModal={setCentredModal} />
      <div className="main-container">
        <Navbar textColor={colorPalette.textColor} toggleShow={toggleShow} toggleGeneralFormShow={toggleGeneralFormShow} />
